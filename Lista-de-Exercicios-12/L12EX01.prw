...
User Function L12EX01()
    ...
    oExcel:AddColumn(cPasta, cTable, 'Código'   , ESQUERDA  , 1)
    oExcel:AddColumn(cPasta, cTable, 'Nome'     , ESQUERDA  , 1)
    oExcel:AddColumn(cPasta, cTable, 'Loja'     , CENTRO    , 1)
    oExcel:AddColumn(cPasta, cTable, 'CNPJ'     , CENTRO    , 1)
    oExcel:AddColumn(cPasta, cTable, 'Endereço' , ESQUERDA  , 1)
    oExcel:AddColumn(cPasta, cTable, 'Bairro'   , ESQUERDA  , 1)
    oExcel:AddColumn(cPasta, cTable, 'Cidade'   , ESQUERDA  , 1)
    oExcel:AddColumn(cPasta, cTable, 'UF'       , CENTRO    , 1)
...
Static Function GeraQuery()
    ...
    cQuery := 'SELECT SA2.A2_COD, SA2.A2_NOME, SA2.A2_LOJA, SA2.A2_CGC, SA2.A2_END, SA2.A2_NR_END, SA2.A2_BAIRRO, SA2.A2_MUN, SA2.A2_EST FROM SA2990 SA2' + CRLF
