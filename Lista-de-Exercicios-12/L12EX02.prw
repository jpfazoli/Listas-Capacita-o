...
User Function L12EX02()
    ...
    oExcel:AddColumn(cPasta, cTable, 'Código'           , CENTRO    , 1)
    oExcel:AddColumn(cPasta, cTable, 'Descrição'        , ESQUERDA  , 1)
    oExcel:AddColumn(cPasta, cTable, 'Tipo'             , CENTRO    , 1)
    oExcel:AddColumn(cPasta, cTable, 'Unidade de Medida', CENTRO    , 1)
    oExcel:AddColumn(cPasta, cTable, 'Preço de Venda'   , ESQUERDA  , 3)
